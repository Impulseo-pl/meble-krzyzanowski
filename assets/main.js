...
(function () {
  ...
  // reveal — BEZ ANIMACJI (27.07.2026): nic nie wjeżdża przy scrollu,
  // wszystko jest widoczne od pierwszej klatki.
...
/* === MOTION LAYER v2 — USUNIĘTA 27.07.2026 (prośba: „wywal animacje") ===
   Cała warstwa ruchu (wjazdy nagłówków linia po linii, kurtyny na zdjęciach,
   parallax, przenikanie kadrów w nagłówku, doliczanie liczb, magnetyczne
   przyciski, pasek postępu) została wyjęta. Strona jest statyczna.
   Dopełnienie po stronie stylów: blok „BEZ ANIMACJI" na końcu assets/styles.css.
   ======================================================================= */
